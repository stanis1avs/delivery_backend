...
Воркер распределения заказов по умолчанию поднимается внутри `index.js`. Чтобы вынести его в отдельный процесс, поставьте `WORKER_IN_PROCESS=false` и запустите:
